...
import {
	...
	typeBadgeVariant,
	typeLabel,
} from "@/lib/static-data/russian/alphabet";
			...
			<div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
				...
				<div className="mb-10">
					...
					<p className="text-muted-foreground text-base max-w-xl leading-relaxed">
						33 letters. Each one shown with its capital, lowercase,
						sound, and a real Russian word to anchor it in memory.
						Hover any card for a learner tip.
					</p>
				</div>
				...
				<Tabs defaultValue="all">
					...
					<TabsContent value="vowel">
						<div className="mb-5 p-4 rounded-xl border border-border bg-muted/40 text-sm text-muted-foreground max-w-2xl leading-relaxed">
							...
							. They come in pairs — each &quot;hard&quot; vowel
							has a &quot;soft&quot; counterpart that also softens
							the consonant before it (А/Я, О/Ё, У/Ю, Э/Е, Ы/И).
						</div>
					...
					<TabsContent value="consonant">
						<div className="mb-5 p-4 rounded-xl border border-border bg-muted/40 text-sm text-muted-foreground max-w-2xl leading-relaxed">
							...
							. Most can be either hard or soft — softness is
							indicated by a following soft vowel or the soft sign
							(Ь), not by the letter itself.
						</div>
					...
					<TabsContent value="special">
						<div className="mb-5 p-4 rounded-xl border border-border bg-muted/40 text-sm text-muted-foreground max-w-2xl leading-relaxed">
							...
							are not pronounced on their own. They modify the
							consonant before them — Ь softens it, Ъ hardens it.
							Ъ is rare; Ь is very common.
						</div>
						<LetterGrid letters={byType("special")} />
					</TabsContent>
				</Tabs>
				...
				<p className="mt-14 text-xs text-muted-foreground text-center max-w-lg mx-auto leading-relaxed">
					...
					Russian sounds vary by position and stress — the examples
					reflect the most common pronunciation for each letter.
				</p>
			</div>
		</main>
	);
